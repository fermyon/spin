...
type InferencingParams struct {
	...
	MaxTokens int32
	// RepeatPenality is the amount the model should avoid repeating tokens.
	// Default: 1.1
	RepeatPenality float32
	// RepeatPenalityLastNTokenCoun the number of tokens the model should
	// apply the repeat penalty to.
	// Default: 64
	RepeatPenalityLastNTokenCount int32
