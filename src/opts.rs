...
pub const BINDLE_SECRET_FILE: &str = "BINDLE_SECRET_FILE";
pub const BINDLE_KEYRING_FILE: &str = "BINDLE_KEYRING_FILE";
pub const BINDLE_LABEL: &str = "BINDLE_LABEL";
pub const BINDLE_LABEL_MATCHING: &str = "BINDLE_LABEL_MATCHING";
pub const BINDLE_ROLE: &str = "BINDLE_ROLE";
