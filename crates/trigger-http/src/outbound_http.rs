...
pub struct OutboundHttpInterceptor<F>
where
...
impl<F> OutboundHttpInterceptor<F>
where
    F: RuntimeFactors + Send + Sync,
    F::AppState: Send + Sync,
    F::InstanceBuilders: Send + Sync,
...
impl<F> spin_factor_outbound_http::OutboundHttpInterceptor for OutboundHttpInterceptor<F>
where
    F: RuntimeFactors + Send + Sync,
    F::AppState: Send + Sync,
    F::InstanceBuilders: Send + Sync,
